...
echo Compiling VERIQ-2.1.5-Setup.exe...
...
dir "C:\Users\HP\.gemini\antigravity\scratch\veriq\VERIQ-2.1.5-Release\VERIQ-2.1.5-Setup.exe" "C:\Users\HP\.gemini\antigravity\scratch\veriq\veriq-launcher.exe" "C:\Users\HP\.gemini\antigravity\scratch\veriq\veriq-setup.iss" > "C:\Users\HP\.gemini\antigravity\scratch\veriq\make-report.txt"
