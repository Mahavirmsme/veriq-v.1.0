...
echo Compiling VERIQ-2.1.3-Setup.exe...
...
dir "C:\Users\HP\.gemini\antigravity\scratch\veriq\VERIQ-2.1.3-Release\VERIQ-2.1.3-Setup.exe" "C:\Users\HP\.gemini\antigravity\scratch\veriq\veriq-launcher.exe" "C:\Users\HP\.gemini\antigravity\scratch\veriq\veriq-setup.iss" > "C:\Users\HP\.gemini\antigravity\scratch\veriq\make-report.txt"
